...
public class QuadTree {
	...
	public QuadTree(int pLevel, Rectangle pBounds) {
		level = pLevel;
		objects = new ArrayList<Projectile>();
		bounds = pBounds;
	...
	public QuadTree(int pLevel, Rectangle pBounds, int maxObjects, int maxLevels) {
		level = pLevel;
		objects = new ArrayList<Projectile>();
		bounds = pBounds;
		nodes = new QuadTree[4];
	 ...
	 */
	private int getIndex(Projectile pRect) {
		int index = -1;
	 ...
	 */
	public void insert(Projectile r) {
		if (nodes[0] != null) {
	 ...
	 */
	public List<Projectile> retrieve(List<Projectile> returnObjects, Projectile pRect) {
	...
	public List<Projectile> retrieve(Projectile pRect) {
		List<Projectile> returnObjects = new ArrayList<Projectile>();
		int index = getIndex(pRect);
		if (index != -1 && nodes[0] != null) {
			nodes[index].retrieve(returnObjects, pRect);
		}
	...
	public List<Projectile> retrieve(double x, double y) {
		List<Projectile> returnObjects = new ArrayList<Projectile>();
	...
	public List<Projectile> retrieve(List<Projectile> returnObjects, double x, double y) {
		int index = getIndex(x, y);
		if (index != -1 && nodes[0] != null) {
			nodes[index].retrieve(returnObjects, x, y);
		}
